package com.chanven.lib.cptr.recyclerview.listener;
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (BaseQuickAdapter)((RecyclerAdapterWithHF) recyclerView.getAdapter()).getmAdapter();
...
//                mPressedView.setPressed(true);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        return (type ==baseQuickAdapter. EMPTY_VIEW || type == baseQuickAdapter.HEADER_VIEW||type==baseQuickAdapter.FOOTER_VIEW);
    }
