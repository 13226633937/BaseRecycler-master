...
import com.chanven.lib.cptr.utils.WrapperUtils;

import java.util.ArrayList;
import java.util.List;

public class RecyclerAdapterWithHF<T extends  RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    public RecyclerView.Adapter<T> mAdapter;
    ...
    public RecyclerView.Adapter<T> getmAdapter() {
        return mAdapter;
    }
    ...
    public T onCreateViewHolderHF(ViewGroup viewGroup, int type) {
        return mAdapter.onCreateViewHolder(viewGroup, type);
    }

    @Override
    public final T onCreateViewHolder(ViewGroup viewGroup, int type) {
        // if our position is one of our items (this comes from
        // getItemViewType(int position) below)
        if (type != TYPE_HEADER && type != TYPE_FOOTER) {
            T vh = onCreateViewHolderHF(viewGroup, type);
            return vh;
            ...
            return (T)new HeaderFooterViewHolder(frameLayout);
        }
    }

    @Override
    public final void onBindViewHolder(final T vh, int position) {
    ...
    public void onBindViewHolderHF(T vh, int position) {
    ...
    // our header/footer RecyclerView.ViewHolder is just a FrameLayoutRecyclerView.ViewHolder
    ...
    public RecyclerAdapterWithHF(RecyclerView.Adapter<T> adapter) {
        super();
