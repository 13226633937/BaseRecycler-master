...
import com.chanven.lib.cptr.recyclerview.entity.IExpandable;
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    if (mSpanSizeLookup == null)
                        ...
                        return (type == EMPTY_VIEW || type == HEADER_VIEW || type == FOOTER_VIEW) ? gridManager.getSpanCount() : mSpanSizeLookup.getSpanSize(gridManager, position - getHeaderLayoutCount());
                }
            });
        }
    }
